...
Да, отпуска и больничные включаются в рабочий опыт, если они являются стандартными по длительности для вашей индустрии, должности и т.п. Например, регулярный годовой отпуск, выходные и праздники в рабочий опыт включатся, но если вы решили брали полгода отпуска за свой счет, чтобы попутешествовать, или ваш работодатель отправлял вас в длительный многомесячный отпуск, потому что не мог обеспечить вашу занятость, этот опыт включать в рабочий опыт не стоит. То же самое с длительными больничными - если вы болели несколько месяцев, этот период из опыта работы нужно исключить.
...
Референсы нужны для подтверждения рабочего опыта, который будет засчитываться по вашей иммиграционной программме. Например, для Express Entry нужно показать всего 3 года опыта - за большее количество лет (если опыт работы не канадский) дополнительных баллов не будет. Однако в пул Express Entry большинство заявителей вне Канады попадает по программе Federal Skilled Workers, а по ней не всегда получается набрать нужные 67 баллов с всего 3 годами опыта. Если это ваш случай, вам нужно будет подтвердить большее количество лет опыта. У провинциальных программ могут быть свои условия. Поэтому прежде чем собирать референсы, определитесь, сколько лет и какого опыта работы вы будете заявлять по иммиграционной программе, чтобы не тратить время на сбор референсов, которые не дадут вам ни дополнительных баллов, ни каких либо других преимуществ. 
...
Точно также как при 30 часах. Рабочая нагрузка от 30 часов в неделю считается full-time занятостью без каких-либо градаций - для IRCC вы работали 1 год и, если ваша рабочая нагрузка в этот год составляла 30 часов в неделю, и если вы работали 60 часов в неделю.

### __8. Зачтут ли рабочий опыт, полученный во время учебы?__

Если вы учились и работали одновременно, то этот рабочий опыт можно зачесть точно также как и любой другой. Важно, чтобы этот опыт был оплачиваемый. Обычно при частичной занятости даже не требуется дополнительных объяснений, как удавалось совмещать учебу с работой. Если вы работали 40 часов в неделю и учились очно, возможно, имеет смысл в двух словах объяснить как это получалось делать, но опыт чата показывает, что офицеры засчитывают такой опыт и без дополнительных объяснений.

### __9. Зачтут ли опыт удаленный опыт работы?__

Никаких ограничений для удаленного опыта работы нет, он засчитывается так же, как и любой другой.

### __10. В условиях программы написано, что засчитывается только иностранный или канадский рабочий опыт? Но я работал только в своей стране!__

Иностранный рабочий опыт - это опыт вне Канады. Так что опыт работы, который вы получили в своей стране, и является иностранным с точки зрения IRCC. То есть иностранный рабочий опыт - это любой неканадский.

### __11. Зачтут ли опыт фрилансерства?__

По Express Entry опыт self-employed засчитывается, хотя его придется подтверждать большим набором документом, чем при работе в качестве наемного сотрудника. По другим программам такой опыт может не приниматься - внимательно изучайте условия программы, по которой планируете подаваться.

### __12. Я работал на компанию как наемный сотрудник, но по факту был ИП, такой опыт тоже доказывается как self-empolyed?__
...
Другими словами, если работодатель даст вам стандартный референс, из которого будет понятно, что вы постоянно работали на данного работодателя с определенной рабочей нагрузкой и оплатой труда, это будет достаточно в общем случае. 
...
### __14. Что делать, если работодатель не хочет/не может выдать референс или не может указать в нем всю требуемую информацию?__
...
В референсе должна присутствовать вся информация, которая требуется по условиям программы. Если какая-то информация указана не будет, ее нужно подтвердить другими документами. Отсутствие даже одного пункта из требуемых может привести к тому, что данный рабочий опыт засчитан не будет, и, если отсутствие этого рабочего опыта влияет на выполнение условий программы, по которой вы подались, ваше заявление получит отказ.

В чате было несколько случаев, когда указание зарплаты в референсе было заменено на фразу "оплата производилась согласно штатному расписанию", и это не вызывало у офицеров дополнительных вопросов. Однако нельзя предполагать, что любой офицер примет такую формулировку и не запросит дополнительные документы для подтверждения оплаты труда или вообще засчитает этот опыт работы.
...
### __27. Что делать, если зарплату платили наличными и не смогу подтвердить ее банковскими выписками?__
...
Помните, что работа меньше 30 часов в неделю считается part-time и будет пересчитана системой в аналог full-time. Такой опыт работы придется в анкете указывать двумя строчками, даже если ваша должность и NOC не менялись - с разным количеством часов в неделю. Референс в этом случае можно оформить так:

>*Мария Иванова работала в компании "Одуванчик" с 1 мая 2020 года по 31 декабря 2023 года на должности бухгалтера, выполняяя слеюущие обязанности: <перечисление обязанностей в соответствие с NOC бухгалтера>*
>
...
Во-первых, для начала убедитесь, что по вашей программе принимается такой опыт работы. Например, по Exrpess Entry такой опыт, если он не канадский, засчитывается, и в требованиях к документам есть даже специальный пункт, в котором перечислены дополнительные документы, которые прикладывают заявители, доказывающие опыт работы на себя.
...
К сожалению, это описание документов, слишком общее, и нет ни одной инструкции, которая подробно перечисляет, сколько и каких документов будет достаточно, чтобы убедить офицера, что вы действительно занимались тем, что заявили в своем профиле. 

Как правило, люди, работающие на себя, прикладывают следующие документы: 
...
Обычно заявители делают три ошибки в документах, которые могут привести к отказу вашего иммиграционного заявления: 

* Не указывают всю необходимую информацию - например, отсутствует количество рабочих часов или не прописаны обязанности. Вся требуемая информация в референсе должна быть обязательно. В нем могут быть добавлены какие-то дополнительные данные о компании или персональная характеристика заявителя - это ошибкой не будет, а вот без обязательной информации заявление может быть отклонено.

* Рабочие обязанности полностью, дословно скопированы из описания NOC. Это абсолютно недопустимо, и сразу вызовет подозрение о офицеров - нельзя предположить, ваши обязанности были абсолютно идентичными указанным на сайте, а если и были - сложно представить, что они описывались ровно теми же словами и выражениями, которые они описаны в NOC.
...
Не всегда в дозапросе будет четко описано, какие именно документы офицер хочет получить - это может быть и четкое требование конкретного документа, например, справки из налоговой, и обтекаемое "свидетельства оплаты труда", иногда с перечислением документов, которые могут в этом качестве выступить. 

<p style="color:red; font-family:arial; font-weight:800; text-align:center; font-size:1em; "Если вы не нашли ответа на ваш вопрос в этом FAQ-е, задайте его в чате [@canadakaknado](https://t.me/canadakaknado).</p>

Если вы не нашли ответа на ваш вопрос в этом FAQ-е, задайте его в чате [@canadakaknado](https://t.me/canadakaknado).
