...
### __2. Я переживаю, что на работе узнают о моих иммиграционных планах, поэтому не могу взять референс, что делать?__
...
### __3. Как писать референс, где найти примеры?__
...
### __6. Нужно ли заверять референс печатью?__
...
### __6. Можно ли подписать референс цифровой подписью?__
...
### __7. Нужны ли подтверждать указанную в референсе информацию другими документами?__
...
### __8. Что делать, если работодатель не хочет/не может выдать референс или не может указать в нем всю требуемую информацию?__
...
### __9. Что делать, если работодатель не хочет/не может указать размер зарплаты?__
...
### __10. Что делать, если работодатель не хочет/не может указать подписывать референс?__
...
### __11. Что делать, если работодатель не хочет/не может указать подписывать референс?__
