...
### __5. Как считать длительность опыта работы, если рабочая нагрузка составляла намного больше 30 часов в неделю?__

Точно также как при 30 часах. Рабочая нагрузка от 30 часов в неделю считается full-time занятостью без каких-либо градаций - для IRCC вы работали 1 год и если ваша рабочая нагрузка составляла 30 часов в неделю, и если вы работали 60 часов в неделю.

### __6. Зачтут ли рабочий опыт, полученный во время учебы?__
...
__ВАЖНО__ Если вы учились в __*канадском*__ колледже или университете, то никакой опыт работы, полученный во время учебы, для иммиграции учитываться не будет.

### __7. Зачтут ли опыт фрилансерства?__
...
### __8. Я работал на компанию как наемный сотрудник, но по факту был ИП, такой опыт тоже доказывается как self-empolyed?__
...
### __9. Что принимается в качестве proof of work experince?__
...
### __10. Что делать, если работодатель не хочет/не может выдать референс или не может указать в нем всю требуемую информацию?__
...
### __11. Можно ли заранее взять референсы у бывших работодателей и у текущего?__
...
### __12. Одна из компаний, опыт из которой мне нужно подтвердить, давно закрылась, где брать референс?__
...
### __13. Я переживаю, что на работе узнают о моих иммиграционных планах, поэтому не могу взять референс, что делать?__
...
### __14 Как писать референс, где найти примеры?__
...
### __15. На каком языке писать референс?__
...
### __16. Что делать, если невозможно взять референс на фирменном бланке?__
...
### __17. Если референс будет на обычном листе бумаги, стоит ли писать его от руки?__

Совершенно точно нет. Рукописный текст никак не повысит валидность документа - только затруднит его чтение.

### __18. Нужно ли заверять референс печатью?__
...
### __19. Можно ли подписать референс цифровой подписью?__
...
### __20. Нужны ли подтверждать указанную в референсе информацию другими документами?__
...
### __21. Что делать, если мой руководитель отказывается подписывать референс?__
...
### __22. Что делать, если работодатель не хочет/не может указать размер зарплаты?__
...
### __23. Что делать, если зарплату платили наличными и не смогу подтвердить ее банковскими выписками?__
...
### __24. Моя зарплата по документам не совпадает с зарплатой в рабочем контракте, это критично?__
...
### __25. У меня не было постоянной зарплаты, размер премий постоянно менялся, что мне указывать в референсе?__
...
### __26. У меня не было четкого графика, рабочие часы варьировались от недели к недели, как в этом случае указать рабочую нагрузку в неделю?__
...
### __27. В процессе работы я несколько раз менял должности, как это отразить в референсе и в анкете?__
...
### __28. Сначала я совмещал работу с учебой, поэтому работал всего 20 часов в неделю, после учебы продолжил работать там же, но уже полный рабочий день, как это отразить в референсе?__
...
### __29. За время моей работы компания сменила юридическое лицо / из ООО стала ЗАО / сменила название / была выкуплена другой компанией, как оформлять референс?__
...
### __30. У меня собраные все документы, подтверждающие опыт работы, но нигде не указано точная сумма зарплаты, это критично?__

Опыт чата показывает, что референс без указания точной зарплаты офицерами принимается, если фраза о зарплате звучит, например как "Получала зарплату согласно штатному расписанию" - важно показать, что работа вообще оплачивалась. При этом нужно помнить, что офицер может строго следовать букве требований, и не засчитать этот опыт работы из-за отсутствия указания сумммы зарплаты, поэтому имеет смысл приложить дополнительные документы, например, квитации о зарплате или справки из налоговой

### __31. У меня собраные все документы, подтверждающие опыт работы, но нигде не указано количество рабочих часов, это критично?__

Рабочие часы, как и даты трудоустройства, должны быть указаны точно. Отсутствие любого из требуемых в референсе пунктов может привести к отказу офицера засчитывать данный рабочий опыт. Поэтому, если какой-то информации в вашем референсе или собранных документах не достает, нужно найти дополнительные способы ее подтверждения.
как проверюятрабочий опыт
