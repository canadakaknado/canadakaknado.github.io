...
Если вы период декретного отпуска и отпуска по уходу за ребенком вы не осуществляли оплачиваемую рабочую деятельность, то включать этот период в рабочий опыт нельзя, даже несмотря на то, что вы продолжали числиться на работе и получать социальные выплаты и пособия. 

### __4. Включаются ли отпуска и больничные в рабочий опыт?__

Да, отпуска и больничные включаются в рабочий опыт, если они являются стандартными по длительности для вашей индустрии, должности и т.п. Например, регулярный годовой отпуск, выходные и праздники в рабочий опыт включатся, но если вы брали полгода отпуска за свой счет, чтобы попутешествовать, или ваш работодатель отправлял вас в длительный многомесячный отпуск, потому что не мог обеспечить вашу занятость, этот опыт включать в рабочий опыт не стоит. То же самое с длительными больничными - если вы болели несколько месяцев, этот период из опыта работы лучше исключить.
...
По Express Entry такой опыт засчитывается, хотя его придется подтверждать большим набором документом, чем при работе в качестве наемного сотрудника (подробнее - ниже). По другим программам такой опыт может не приниматься - внимательно изучайте условия программы, по которой планируете подаваться.
...
* Трудовая книжка подтверждает должность, даты начала и окончания работы в компании.
...
Референс должен быть на фирменно бланке, в котором указана контактная информация компании. Референс должен быть подисан непосредственным руководителем или HR компании. Опыт показыват, что подпись более высокого начальства тоже не вызывает вопросов. Если на фирменном бланке компании отсутствует адрес, телефон или емейл, эту информацию можно включить непосредственно в тело референса.
...
Примеры реальных референсом можно найти и здесь: [canadakaknado.info](https://canadakaknado.info) ➡️ Полезные ссылки ➡️ Образцы документов ➡️ Примеры оформления reference letters.
...
<p style="color:red; font-family:arial; font-weight:800; text-align:center; font-size:1em; ">>Если вы не нашли ответа на ваш вопрос в этом FAQ-е, задайте его в чате <a href="https://t.me/canadakaknado">@canadakaknado</a><br>об иммиграции в Канаду</p>
