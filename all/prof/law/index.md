...
После получения NCA сертификата и регистрации в Law Society, Law Society официально допускает кандидата к следующему этапу – сдаче экзаменов и прохождению the Experiential Training Program. Эти два процесса могут идти параллельно, то есть кандидат может начать Training Program и в процессе работы сдавать бар экзамены. Но обычно сначала сдаются бар экзамены, а некоторые работодатели даже указывают сданные экзамены в качестве требования к допуску к стажировке.
