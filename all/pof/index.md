...
<p style="text-align: center;"> <img src="http://canadakaknado.info/assets/images/pof.gif" width="600" img style="border:1px solid black"> </p>
...
### __Мой PoF хранится по частям на нескольких разных счетах в разных банках. Это допустимо?__
...
### __У меня получается слишком много документов - одних только транзакций на сто страниц, а ведь еще переводы, что делать?__
...
### __Ура, пришло письмо, что моя подача одобрена, могу ли я теперь тратить PoF?__
...
### __То есть деньги нужно везти налом, чтобы была возможность показать их на границе?__
