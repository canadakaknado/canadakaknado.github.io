...
11. В чате __ЗАПРЕЩЕНЫ:__
  ...
  __Реклама любых своих услуг расценивается как спам, а разместивший рекламу участник чата автоматически удаляется из чата с баном.__

    В чате __РАЗРЕШЕНЫ__ ссылки на:
...
* [Список лицензированных иммиграционных консультантов Канады](https://iccrc-crcic.ca/find-a-professional/)(правильная ссылка открывается только с компьютера, при открытии с мобильных устройств нужно выбирать десктопную версию сайта)
