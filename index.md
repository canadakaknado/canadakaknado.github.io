...
2. В [@canadakaknado](https://t.me/canadakaknado) обсуждаются вопросы:
     ...
     **Если вы хотите разместить в чате какую-то информацию или задать вопрос, но не уверены, чо это не нарушит правила чата, получите разрешение у администрации чата (связь - через бота __[@CaptainCanada_bot](https://t.me/CaptainCanada_bot)__).**
