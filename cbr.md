...
11. Если ваш ник каким-то образом мешает удобной коммуникации в чате (например, если вы используете специфические символы, которые не всегда отображаются в разных клиентах телеграма корректно), и на это поступят жалобы, администрация чата оставляет за собой право перевести вас в режим RO, предварительно предупредив о том, что ваш ник мешает другим участникам чата. 

12.  __Обсуждение действий администратора и замечатий администрации чата и любой флуд на эту тему ведут к режиму read only на 1 месяц. Эти вопросы обсуждаются напрямую с [@CaptainCanada_bot](https://t.me/CaptainCanada_bot)__  
