...
Личные объявления (продажа чего-нибудь, сдача или съем квартиры и т.п.) публикуются только с разрешения администрации чата. Если объявление размещено без разрешения администрации, оно удаляется.
