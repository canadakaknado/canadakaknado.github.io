...
__WP__ - _Work permit_, разрешение на работу. Бывает двух основных типов: employer-specific work permits или closed work permit (разрешение на работу на конкретного работодателя) и open work permit (открытое разрешение на работу, позволяющее работать на любого работодателя). 
